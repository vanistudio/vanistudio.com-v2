  ...
  return (
    <input
      ...
      className={cn(
        ...
        "bg-transparent px-2.5 py-1 text-base",
        "transition-colors outline-none",

        "file:inline-flex file:h-6 file:border-0",
        "file:bg-transparent file:text-sm",
        "file:font-medium file:text-foreground",

        "placeholder:text-muted-foreground",

        "focus-visible:border-vanixjnk",
        "focus-visible:ring-3 focus-visible:ring-vanixjnk/50",
