                ...
                return (
                  <Card key={blog.id} className="group relative flex flex-col h-full bg-card/30 border-border p-0!">
                    <div className="relative aspect-video w-full overflow-hidden rounded-t-xl bg-muted/20 border-b border-border/55 flex items-center justify-center select-none">
                      ...
                      {blog.publishedAt && (
                        <span className="absolute bottom-2 right-2 px-2 py-0.5 rounded text-[9px] font-semibold tracking-wider shadow-md border z-10 flex items-center gap-1 bg-background/80 text-muted-foreground border-border/50 backdrop-blur-md">
                          <Icon icon="solar:calendar-line-duotone" className="size-3 shrink-0" />
                    ...
                    <div className="flex flex-col flex-1 p-5 gap-3">
                      <div className="space-y-1">
                        <Link href={`/blog/${blog.slug}`} className="after:absolute after:inset-0 after:z-10">
