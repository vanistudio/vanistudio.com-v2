  ...
  const columns = React.useMemo<ColumnDef<TelegramAccount>[]>(() => [
    ...
    },
    {
      ...
      cell: ({ row }) => {
        ...
        const name = getDisplayName(acc.firstName, acc.lastName);
        return (
          <div className="flex items-center gap-3">
            {acc.avatar ? (
              ...
              <div className="size-9 rounded-full bg-vanixjnk/10 text-vanixjnk border border-vanixjnk/20 flex items-center justify-center">
                <Icon icon="solar:user-bold-duotone" className="size-5 text-vanixjnk/75" />
              </div>
            )}
