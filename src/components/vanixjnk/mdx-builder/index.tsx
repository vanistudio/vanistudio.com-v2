...
const evaluatePropValue = (val: string, scope: Record<string, any>): any => {
...
const parseTagContent = (tagStr: string, scope: Record<string, any>): { name: string; props: Record<string, any> } => {
...
const tokenizeMdx = (input: string, scope: Record<string, any>): MdxToken[] => {
