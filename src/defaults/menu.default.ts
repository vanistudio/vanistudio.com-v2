    ...
    items: [
      ...
      { name: "Liên hệ", url: "/contact", icon: "solar:letter-line-duotone", order: 6 },
      {
        ...
        children: [
          ...
          { name: "Check ID", url: "/tools/check-id", icon: "solar:card-rec-line-duotone", order: 2 },
      ...
      },
      {
        ...
        order: 8,
        children: [
          { name: "Điều khoản", url: "/policies/terms", icon: "solar:document-text-line-duotone", order: 1 },
          { name: "Bảo mật", url: "/policies/privacy", icon: "solar:lock-keyhole-line-duotone", order: 2 },
          { name: "Hoàn tiền", url: "/policies/refund", icon: "solar:bill-list-line-duotone", order: 3 },
          { name: "Giao nhận", url: "/policies/delivery", icon: "solar:delivery-line-duotone", order: 4 },
          { name: "Bảo hành", url: "/policies/warranty", icon: "solar:shield-check-line-duotone", order: 5 },
          { name: "Thanh toán", url: "/policies/payment", icon: "solar:card-line-duotone", order: 6 },
        ],
      },
    ],
  },
